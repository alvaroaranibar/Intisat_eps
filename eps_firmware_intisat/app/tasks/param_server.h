...
#define NOTIFICATION_VALUE_FROM_SAFE_MODE_ISR       (1UL << 0UL)        /**< Bit to set on safe_mode ISR notification */
#define NOTIFICATION_VALUE_FROM_I2C_ISR       		(1UL << 1UL)        /**< Bit to set on i2c_slave ISR notification. */
#define NOTIFICATION_VALUE_FROM_UART_ISR            (1UL << 2UL)        /**< Bit to set on uart ISR notification. */
